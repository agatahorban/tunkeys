 ...
 * @author Agata
 */
@Named("addvocalalbums")
@Scope("request")
@Transactional
public class AddVocalistAlbumsController {

    private MVocalist currentVocalist;
    ...
    private String vocalistArtisticName;
    ...
    public AddVocalistAlbumsController() {
    }

    @PostConstruct
    public void init() {
        vocalistArtisticName = FacesContext.getCurrentInstance().getExternalContext().getRequestParameterMap().get("vocalname");
        currentVocalist = vri.findVocalistByName(vocalistArtisticName);
    ...
    public String addAlbums(Long a) {
        currentVocalist = vri.find(a);
    ...
    public MVocalist getCurrentVocalist() {
        return currentVocalist;
    }

    public void setCurrentVocalist(MVocalist currentVocalist) {
        this.currentVocalist = currentVocalist;
    }
    ...
    public String getVocalistArtisticName() {
        return vocalistArtisticName;
    }

    public void setVocalistArtisticName(String vocalistArtisticName) {
        this.vocalistArtisticName = vocalistArtisticName;
    }
